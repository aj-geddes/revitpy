...
class WebSocketBridgeServer:
    ...
    async def start(self):
        ...
        try:
            ...
            self.logger.info(f"WebSocket server started on "
            ...
            self.is_running = False
            raise BridgeConnectionError("websocket", f"Failed to start WebSocket server: {e}")
    ...
    async def _process_message(self, message: Dict[str, Any], connection_id: str) -> Optional[Dict[str, Any]]:
    ...
    async def broadcast_message(self, message: Dict[str, Any], exclude_connection: Optional[str] = None) -> int:
    ...
    def get_server_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'active_connections_count': len([c for c in self.connections.values() if c.is_active])
        }
...
class WebSocketBridgeClient:
    ...
    def __init__(self, host: str = "localhost", port: int = 8765, path: str = "/bridge"):
    ...
    async def get_next_message(self, timeout: Optional[int] = None) -> Dict[str, Any]:
