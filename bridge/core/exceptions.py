...
class BridgeTimeoutError(BridgeException):
    ...
    def __init__(self, operation: str, timeout_seconds: int, 
                 context: Optional[Dict[str, Any]] = None):
        message = f"Bridge operation '{operation}' timed out after {timeout_seconds} seconds"
...
class BridgeConnectionError(BridgeException):
    ...
    def __init__(self, connection_type: str, details: str,
                 context: Optional[Dict[str, Any]] = None):
...
class BridgeDataError(BridgeException):
    ...
    def __init__(self, operation: str, data_type: str, details: str,
                 context: Optional[Dict[str, Any]] = None):
...
class BridgeSecurityError(BridgeException):
    ...
    def __init__(self, security_check: str, details: str,
                 context: Optional[Dict[str, Any]] = None):
...
class BridgeResourceError(BridgeException):
    ...
    def __init__(self, resource_type: str, limit: Any, current: Any,
                 context: Optional[Dict[str, Any]] = None):
        message = f"Bridge resource limit exceeded ({resource_type}): {current} > {limit}"
