...
from ..core.exceptions import BridgeConnectionError, BridgeException, BridgeTimeoutError
...
class RevitPyBridge:
    ...
    def __init__(
        ...
        self._client: WebSocketBridgeClient | None = None
            ...
            if not self.is_connected():
                if not self.connect():
                    raise BridgeConnectionError(
                        "websocket", "Failed to connect to RevitPy bridge"
                    )
    ...
    def _execute_analysis_websocket(
        self,
        elements: list[Any],
        analysis_type: str,
        ...
        try:
            ...
            response = loop.run_until_complete(
                self._client.send_message(
                    {"type": "analysis_request", "data": request},
    ...
    def _execute_analysis_file_exchange(
        self,
        elements: list[Any],
        analysis_type: str,
        parameters: dict[str, Any] | None,
    ...
    def test_connection(self) -> dict[str, Any]:
        ...
        try:
            ...
            response = loop.run_until_complete(
                self._client.send_message(
                    {"type": "ping"}, expect_response=True, timeout=10
                )
            )
    ...
    def get_server_status(self) -> dict[str, Any]:
        ...
        try:
            ...
            response = loop.run_until_complete(
                self._client.send_message(
                    {"type": "get_status"}, expect_response=True, timeout=10
                )
            )
