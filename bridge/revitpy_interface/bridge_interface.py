...
from ..core.bridge_manager import BridgeManager, AnalysisRequest, AnalysisResult
from ..core.config import BridgeConfig
from ..core.exceptions import BridgeException, BridgeAnalysisError
from .analysis_handlers import get_handler_registry, AnalysisHandlerRegistry
...
class RevitPyBridgeInterface:
    ...
    def _register_analysis_handlers(self):
        ...
        for analysis_type in self.handler_registry.handlers:
            ...
            async def analysis_wrapper(elements_data: List[Dict[str, Any]], 
                                     parameters: Dict[str, Any],
                                     analysis_type=analysis_type) -> Dict[str, Any]:
            ...
            self.bridge_manager.register_analysis_handler(analysis_type, analysis_wrapper)
    ...
    def get_analysis_info(self, analysis_type: str) -> Optional[Dict[str, Any]]:
        """
    ...
    async def validate_analysis_request(self, request: AnalysisRequest) -> Dict[str, Any]:
        """
    ...
    def register_custom_handler(self, 
        ...
        try:
            ...
            self.handler_registry.register(analysis_type, **handler_config)(handler_function)
            
            # Register with bridge manager
            async def custom_wrapper(elements_data: List[Dict[str, Any]], 
...
async def create_and_run_bridge(config: Optional[BridgeConfig] = None,
                              port: Optional[int] = None) -> RevitPyBridgeInterface:
    """
...
async def main():
    ...
    try:
        ...
        print(f"WebSocket server: ws://localhost:{bridge.config.communication.websocket_port}/bridge")
