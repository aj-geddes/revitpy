...
def main():
    ...
    try:
        ...
        if walls:
            ...
            print(
                f"   Retrieved {len(retrieved_elements)} elements from {len(wall_ids)} IDs"
            )
        ...
        for pattern in search_patterns:
            matching_elements = query_tool.search_elements_by_name(
        ...
        if walls:
            ...
            key_params = query_tool.get_element_parameters(
                sample_wall, ["Height", "Width", "Area", "Volume", "Type Mark", "Level"]
            )
