...
from src.utils import MockRevitPy, MockDocument, MockElement
...
class TestElementQueryTool(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('src.element_query.RevitAPI', return_value=self.mock_revit):
            ...
            self.query_tool = ElementQueryTool(log_level="ERROR")  # Suppress logs in tests
    ...
    def test_get_elements_by_category_success(self):
        ...
        with patch('src.element_query.FilteredElementCollector') as mock_collector:
            mock_elements = [MockElement(1, "Walls", "Wall 1"), MockElement(2, "Walls", "Wall 2")]
            
            mock_collector_instance = Mock()
            mock_collector.return_value = mock_collector_instance
            mock_collector_instance.of_category.return_value = mock_collector_instance
            mock_collector_instance.where_element_is_not_element_type.return_value = mock_collector_instance
    ...
    def test_get_elements_by_category_with_types(self):
        ...
        with patch('src.element_query.FilteredElementCollector') as mock_collector:
            ...
            result = self.query_tool.get_elements_by_category("Walls", include_types=True)
    ...
    def test_get_elements_by_category_error(self):
        ...
        with patch('src.element_query.FilteredElementCollector', side_effect=Exception("Test error")):
            with pytest.raises(Exception):  # Should raise RevitPyException
    ...
    def test_get_element_parameters(self):
        ...
        specific_params = self.query_tool.get_element_parameters(element, ["Height", "NonExistent"])
    ...
    def test_search_elements_by_name(self):
        ...
        with patch('src.element_query.FilteredElementCollector') as mock_collector:
            ...
            result = self.query_tool.search_elements_by_name("Wall", case_sensitive=True)
            self.assertEqual(len(result), 2)
    ...
    def test_get_statistics(self):
        ...
        with patch('src.element_query.FilteredElementCollector') as mock_collector:
            ...
            mock_collector_instance.of_category.return_value = mock_collector_instance
            mock_collector_instance.where_element_is_not_element_type.return_value = mock_collector_instance
            mock_collector_instance.to_elements.return_value = [MockElement(1, "Walls", "Wall")]
...
include_geometry: false
        ...
        try:
            with patch('src.element_query.RevitAPI'):
                with patch('src.element_query.RevitAPI.return_value.get_active_document', return_value=self.mock_doc):
