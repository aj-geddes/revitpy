...
class TestParameterFilter(unittest.TestCase):
    ...
    def test_equals_filter_case_insensitive(self):
        ...
        filter_condition = ParameterFilter(
            "Type Mark", "w1", "equals", case_sensitive=False
        )
    ...
    def test_contains_filter(self):
        ...
        self.assertFalse(
            filter_condition.matches(self.elements[2])
        )  # D1 doesn't contain W
...
class TestGeometryFilter(unittest.TestCase):
    ...
    def test_bounds_filter_point_location(self):
        ...
        bounds = {"min": {"x": -5, "y": -5, "z": -1}, "max": {"x": 5, "y": 5, "z": 1}}
    ...
    def test_combined_constraints(self):
        ...
        filter_condition = GeometryFilter(
            bounds=bounds, min_area=75.0, max_volume=1500.0
        )
...
class TestCustomElementFilter(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.elements[2].Parameters.extend(
            [MockParameter("Type Mark", "D1"), MockParameter("Area", 20.0)]
        )

        self.elements[3].Parameters.extend(
            [MockParameter("Type Mark", "W1"), MockParameter("Area", 15.0)]
        )
