...
class TestEnergyAnalytics(unittest.TestCase):
    ...
    def test_energy_performance_analysis(self):
        ...
        # Perform analysis
        results = self.analyzer.analyze_energy_performance(
            days=30
        )  # Shorter for testing
    ...
    def test_machine_learning_capabilities(self):
        ...
        self.assertGreater(
            ml_results["r2_score"], 0.5
        )  # Should explain >50% of variance
    ...
    def test_clustering_analysis(self):
        ...
        print("   ✅ All clusters have valid space assignments")
    ...
    def test_interactive_dashboard_creation(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                print("   ✅ Contains Plotly visualization code")
    ...
    def test_pyrevit_limitation_simulation(self):
        ...
        print("   ✅ All limitations have explanations and workarounds")
...
class TestEnergyAnalyticsIntegration(unittest.TestCase):
    ...
    def test_end_to_end_workflow(self):
        ...
        print("   ✅ All analysis components generated results")
    ...
    def test_roi_calculation_accuracy(self):
        ...
        self.assertLess(
            savings["potential_savings_percentage"], 100
        )  # Should be realistic
        ...
        self.assertAlmostEqual(
            total_calculated, savings["total_potential_savings"], places=2
        )
