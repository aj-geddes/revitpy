...
class TestStructuralAnalysis(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_elements = get_elements(category="StructuralFraming")[
            :20
        ]  # Limit for testing
    ...
    def test_load_combinations_definition(self):
        ...
        print("   ✅ Combinations follow ASCE 7 standard")
    ...
    def test_sparse_matrix_operations(self):
        ...
        self.assertEqual(
            stiffness_matrix.shape[0], stiffness_matrix.shape[1]
        )  # Square matrix
    ...
    def test_seismic_response_analysis(self):
        ...
        seismic_keys = [
            ...
            "duration_seconds",
            "time_steps",
            "peak_displacement_inches",
            "peak_base_shear_kips",
            "max_story_drift_percent",
            "fundamental_period_seconds",
        ]
        ...
        self.assertIn(
            results["seismic_performance_level"],
            performance_levels + ["Exceeds Performance Levels"],
        )

        print(f"   ✅ Time-history analysis: {results['duration_seconds']}s")
        print(
            f"   ✅ Peak displacement: {results['peak_displacement_inches']:.3f} inches"
        )
    ...
    def test_wind_load_analysis(self):
        ...
        wind_keys = [
            ...
            "building_height_ft",
            "max_wind_pressure_psf",
            "total_wind_force_lbs",
            "lateral_drift_inches",
            "drift_ratio",
        ]
    ...
    def test_structural_optimization(self):
        ...
        if optimization_results:
            print(
                f"   ✅ Optimization success: {optimization_results.get('optimization_success', False)}"
            )
    ...
    def test_numerical_methods_accuracy(self):
        ...
        period = self.analyzer._calculate_fundamental_period(
        ...
        story_drifts = self.analyzer._calculate_story_drifts(
            displacement_history, self.test_elements
        )
        ...
        print("   ✅ Numerical methods accuracy verified")
        print(f"   ✅ Fundamental period: {period:.2f} seconds")
        print("   ✅ Story drift calculations validated")
    ...
    def test_material_property_validation(self):
        ...
        safety_analysis = self.analyzer._analyze_safety_factors(
            test_stresses, element_properties
        )
        ...
        print("   ✅ Material property validation completed")
        print("   ✅ Steel section recommendations verified")
        print("   ✅ Safety factor calculations validated")
...
class TestStructuralAnalysisPerformance(unittest.TestCase):
    ...
    def test_sparse_matrix_performance(self):
        ...
        with benchmark.measure_performance("large_sparse_matrix"):
            ...
            stiffness_matrix = analyzer._build_global_stiffness_matrix(
                element_properties
            )
        ...
        self.assertLess(
            latest_result.execution_time, 10.0
        )  # Should complete in under 10 seconds
        self.assertLess(
            latest_result.memory_usage_mb, 100
        )  # Should use reasonable memory

        print("   ✅ Sparse matrix performance test completed")
    ...
    def test_numerical_integration_performance(self):
        ...
        print("   ✅ Numerical integration performance verified")
        print(f"   ✅ Execution time: {latest_result.execution_time:.3f}s")
    ...
    def test_memory_efficiency(self):
        ...
        self.assertLess(
            latest_result.memory_usage_mb, 200
