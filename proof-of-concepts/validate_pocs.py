...
class POCValidator:
    ...
    def validate_code_structure(self):
        ...
        for poc in self.pocs:
            ...
            try:
                ...
                with open(main_module_path) as f:
                    content = f.read()
                ...
                print(
                    f"   📊 Methods found: {key_methods_found}/{len(poc['key_methods'])}"
                )
        ...
        for poc in self.pocs:
            ...
            if docs_dir.exists():
                ...
                if doc_files:
                    ...
                    print("   ⚠️  No .md files in docs directory")
            else:
                print("   ❌ No docs directory found")
                all_valid = False

        # Check for master documentation
        master_docs = ["MASTER_DOCUMENTATION.md", "README.md"]
        ...
        for poc in self.pocs:
            ...
            if examples_dir.exists():
                ...
                if example_files:
                    ...
                    print("   ⚠️  No .py files in examples directory")
            else:
            ...
            if tests_dir.exists():
                ...
                if test_files:
                    ...
                    print("   ⚠️  No test_*.py files in tests directory")
            else:
    ...
    def run_validation(self):
        ...
        print("=" * 60)
        print(
            "⚠️  This validation checks structure without requiring external dependencies"
        )
        print()
