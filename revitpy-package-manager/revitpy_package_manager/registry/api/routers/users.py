...
async def get_user_profile(username: str, db: AsyncSession = Depends(get_db_session)):
...
@router.post(
    "/me/api-keys", response_model=APIKeyWithToken, status_code=status.HTTP_201_CREATED
)
