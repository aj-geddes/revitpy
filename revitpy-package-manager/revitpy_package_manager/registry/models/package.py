...
class Package(Base):
    ...
    documentation_url: Mapped[Optional[str]] = mapped_column(String(2048))
    bug_tracker_url: Mapped[Optional[str]] = mapped_column(String(2048))
...
class PackageVersion(Base):
    ...
    python_version: Mapped[str] = mapped_column(String(50), nullable=False, default=">=3.11")
    ...
    def __repr__(self) -> str:
        return f"<PackageVersion(package='{self.package.name}', version='{self.version}')>"
...
class PackageDependency(Base):
    ...
    extra: Mapped[Optional[str]] = mapped_column(String(100))  # For optional dependencies
    ...
    # Relationships
    version: Mapped["PackageVersion"] = relationship("PackageVersion", back_populates="dependencies")
