...
from revitpy_package_manager.registry.api.routers.auth import JWT_SECRET_KEY, JWT_ALGORITHM
...
class TestAuthenticationSecurity:
    ...
    def test_jwt_secret_required(self):
        ...
        with patch.dict(os.environ, {}, clear=True):
            with pytest.raises(ValueError) as exc_info:
                from revitpy_package_manager.registry.api.routers.auth import JWT_SECRET_KEY
    ...
    def test_sql_injection_prevention(self, client):
        ...
        for payload in sql_payloads:
            ...
            assert response.status_code in [401, 422]  # 422 for validation error, 401 for auth error
    ...
    def test_token_expiration(self, client):
        ...
        with patch.dict(os.environ, {
            "JWT_SECRET_KEY": "test_secret_key_32_chars_minimum"
        }):
            expired_token = jwt.encode(payload, "test_secret_key_32_chars_minimum", algorithm="HS256")
...
class TestPasswordSecurity:
    ...
    def test_password_hashing(self):
        ...
        from revitpy_package_manager.registry.api.routers.auth import get_password_hash, verify_password
