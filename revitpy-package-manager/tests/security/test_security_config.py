...
from revitpy_package_manager.security.config import SecurityConfig, ensure_secure_environment
...
class TestSecurityConfig:
    ...
    def test_sanitize_user_input(self):
        ...
        # With whitespace
        assert SecurityConfig.sanitize_user_input("  text with spaces  ") == "text with spaces"
        ...
        assert SecurityConfig.sanitize_user_input("line1\nline2\tindented") == "line1\nline2\tindented"
