...
@pytest.mark.integration
def test_create_package_success(test_client: TestClient, auth_headers, mock_package_data):
    """Test creating a new package."""
    response = test_client.post(
        "/api/v1/packages/",
        json=mock_package_data,
...
def test_package_name_normalization():
    ...
    from revitpy_package_manager.registry.api.routers.packages import normalize_package_name
