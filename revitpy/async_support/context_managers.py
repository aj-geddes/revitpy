...
from ..api.transaction import Transaction, TransactionOptions, ITransactionProvider
...
class BatchOperationManager:
    ...
    async def execute_remaining(self) -> None:
        ...
        logger.debug(f"Completed all batch operations, total executed: {self._executed_count}")
