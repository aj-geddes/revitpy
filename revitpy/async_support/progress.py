...
class ProgressReporter(IProgressReporter):
    ...
    def __init__(self, total: Optional[int] = None) -> None:
        ...
        self._throttle_interval = timedelta(milliseconds=100)  # Throttle to 10 updates per second
    ...
    def increment(self, amount: int = 1, message: Optional[str] = None, **data) -> None:
        """Increment progress by amount."""
        self._current = min(self._total, self._current + amount)
        self._update_progress(message, **data)
    
    def set_progress(self, current: int, message: Optional[str] = None, **data) -> None:
    ...
    def complete(self, message: Optional[str] = None, **data) -> None:
    ...
    def fail(self, message: Optional[str] = None, error: Optional[Exception] = None, **data) -> None:
    ...
    def cancel(self, message: Optional[str] = None, **data) -> None:
    ...
    def _update_progress(self, message: Optional[str] = None, **data) -> None:
        """Update progress and notify callbacks."""
        # Throttle updates to avoid overwhelming callbacks
        now = datetime.now()
        if (self._last_report_time and 
            now - self._last_report_time < self._throttle_interval and
            self._current < self._total):
            return
...
class ConsoleProgressReporter(ProgressReporter):
    ...
    def __init__(self, total: Optional[int] = None, show_percentage: bool = True) -> None:
...
class AsyncProgressReporter(ProgressReporter):
    ...
    async def async_increment(self, amount: int = 1, message: Optional[str] = None, **data) -> None:
    ...
    async def async_complete(self, message: Optional[str] = None, **data) -> None:
