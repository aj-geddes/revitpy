...
class MockDocument:
    ...
    def GetElementsByType(self, element_type: str) -> list[MockElement]:
        ...
        return [
            elem for elem in self._elements.values() if elem.ElementType == element_type
        ]
...
class MockApplication:
    ...
    def __init__(self) -> None:
        ...
        self._active_document: MockDocument | None = None

    @property
    def ActiveDocument(self) -> MockDocument | None:
        """Get active document."""
...
class MockRevit:
    ...
    @property
    def active_document(self) -> MockDocument | None:
        """Get active document."""
    ...
    def save_state(self, file_path: str) -> None:
        ...
        state = {
            ...
            "active_document_title": self.active_document.Title
            if self.active_document
            else None,
    ...
    def get_statistics(self) -> dict[str, Any]:
        ...
        total_elements = sum(
            doc.GetElementCount() for doc in self.application._documents
        )
