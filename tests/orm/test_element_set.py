...
class MockElement:
    ...
    def __repr__(self):
        return f"MockElement(id={self.id}, name='{self.name}', category='{self.category}')"
...
class TestElementSet:
    ...
    def test_first_operations(self, sample_elements):
        ...
        first_default = element_set.first_or_default(
            lambda x: x.category == "NonExistent",
            default=None
        )
    ...
    def test_aggregation_operations(self, sample_elements):
        ...
        assert id_average == sum(elem.id for elem in sample_elements) / len(sample_elements)
    ...
    def test_chained_operations(self, sample_elements):
        ...
        result = (element_set
                 .where(lambda x: x.category in ["Wall", "Door"])
