...
from revitpy.orm.query_builder import QueryBuilder, LazyQueryExecutor, QueryPlan
from revitpy.orm.types import IElementProvider, CachePolicy
...
class MockElement:
    ...
    def __init__(self, id: int, name: str, category: str = "Wall", level: str = "Level 1"):
        self.id = id
        self.name = name
...
class TestQueryBuilder:
    ...
    def test_first_or_default(self, mock_provider, cache_manager):
        ...
        result = builder.first_or_default(lambda x: x.category == "NonExistent", "default")
    ...
    def test_chained_operations(self, mock_provider, cache_manager):
        ...
        results = (builder
                  .where(lambda x: x.category == "Wall")
