...
class TestBaseElement:
    ...
    def test_valid_base_element(self):
        ...
        element = BaseElement(id=123, name="Test Element", category="TestCategory")
...
class TestWallElement:
    ...
    def test_valid_wall_element(self):
        ...
        wall = WallElement(id=1, height=10.0, length=20.0, width=0.5, name="Test Wall")
...
class TestDoorElement:
    ...
    def test_valid_door_element(self):
        ...
        door = DoorElement(
            id=1, width=3.0, height=7.0, material="Wood", fire_rating=0.75, hand="Left"
        )
...
class TestElementValidator:
    ...
    def test_validator_creation(self):
        ...
        validator = ElementValidator(ValidationLevel.STRICT, custom_rules=[custom_rule])
    ...
    def test_custom_rules(self):
        ...
        validator = ElementValidator(
            ValidationLevel.STANDARD, custom_rules=[custom_rule]
        )
        ...
        assert (
            len(
                [
                    e
                    for e in errors.get("name", [])
                    if "must be at least 5 characters" in e
                ]
            )
            == 0
        )
...
class TestTypeSafetyMixin:
    ...
    def test_ensure_type_safety_dict_conversion(self):
        ...
        wall_data = {"id": 1, "height": 10.0, "length": 20.0, "width": 0.5}
...
class TestFactoryFunctions:
    ...
    def test_create_wall(self):
        ...
        wall = create_wall(id=1, height=10.0, length=20.0, width=0.5, name="Test Wall")
    ...
    def test_create_room(self):
        ...
        room = create_room(id=1, number="101", area=200.0, name="Conference Room")
    ...
    def test_create_door(self):
        ...
        door = create_door(id=1, width=3.0, height=7.0, material="Wood")
    ...
    def test_create_window(self):
        ...
        window = create_window(id=1, width=4.0, height=3.0, glass_type="Double Pane")
