...
class TestElement:
    ...
    def mock_element_data(self):
        ...
        return {
            ...
            "Name": "Test Wall",
            "Category": "Walls",
            "Parameters": {"Height": 3000.0, "Width": 200.0, "Material": "Concrete"},
    ...
    async def test_element_save(self, mock_element_data, mock_session):
        ...
        mock_session.api_wrapper.call_api.assert_called_once_with(
            "UpdateElement", {"elementId": 12345, "parameters": {"Height": 3500.0}}
        )
        assert not element._dirty
...
class TestWallModel:
    ...
    def mock_wall_data(self):
        ...
        return {
            ...
            "Compound": {"Layers": [{"Material": "Concrete", "Thickness": 200.0}]},
        }
    ...
    async def test_wall_relationships(self, mock_wall_data, mock_session):
        ...
        mock_session.api_wrapper.call_api.assert_called_once_with(
            "GetHostedElements", {"hostId": 67890}
        )
...
class TestParameter:
    ...
    def test_parameter_type_validation(self, mock_element):
        ...
        length_param = Parameter(
            "Height", 3000.0, parameter_type="Length", element=mock_element
        )
...
class TestQueryBuilder:
    ...
    async def test_query_execution(self, mock_session):
        ...
        query = (
            QueryBuilder(session=mock_session).filter_by_category("Walls").of_type(Wall)
        )
    ...
    async def test_query_count(self, mock_session):
        ...
        mock_session.api_wrapper.call_api.assert_called_once_with(
            "CountElements",
            {"filters": [{"type": "category", "value": "Walls"}], "element_type": None},
        )
